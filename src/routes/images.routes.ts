...
imagesRoutes.post("/:productId", upload.array('images', 6), imagesController.create);
...
imagesRoutes.post("/shuffle/:productId", upload.array('images', 6), imagesController.shuffleImages);
